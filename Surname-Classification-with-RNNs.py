...
if args.reload_from_files and os.path.exists(args.vectorizer_file):
    ...
    dataset = SurnameDataset.load_dataset_and_make_vectorizer("surnames_with_splits.csv")
    dataset.save_vectorizer(args.vectorizer_file)

vectorizer = dataset.get_vectorizer()

print("CharVocab特殊标记索引：",
      f"<BEG>{vectorizer.char_vocab.begin_seq_index}",
...
for surname in test_surnames:
    ...
    print(f"姓氏: {result['surname']:>8} | "
          f"预测国籍: {result['nationality']:>10} | "
